_base_ = [
    '../../../../configs/_base_/datasets/m2dset2.py',
...
point_cloud_range = [-40.2, -40.2, -4.0, 150.2, 40.2, 2.0]
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        position_range=[-50.2, -50.2, -10.0, 160.2, 50.2, 10.0],
        normedlinear=False,
        code_size=8,
        ...
        bbox_coder=dict(
            type='NMSFreeCoder',
            post_center_range=[-50.2, -50.2, -10.0, 160.2, 50.2, 10.0],
...
dataset_type = 'CustomM2DSetDataset'
data_root = 'data/m2dset/'
backend_args = None

db_sampler = dict(
    data_root=data_root,
    info_path=data_root + 'm2dset2_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(
...
train_pipeline = [
    ...
    dict(
        ...
        keys=[
            'img', 'gt_bboxes', 'gt_bboxes_labels', 
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='m2dset2_infos_trainval.pkl',
...
test_dataloader = dict(
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='m2dset2_infos_test.pkl',
        data_prefix=data_prefix,
...
val_evaluator = dict(
    ...
    ann_file=data_root + 'm2dset2_infos_test.pkl',
    metric='bbox',
